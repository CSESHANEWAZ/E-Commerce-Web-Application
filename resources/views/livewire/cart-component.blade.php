...
<main id="main" class="main-site">
    ...
    <div class="container">
        ...
        <div class=" main-content-area">
            ...
            <hr>
            <div class="wrap-iten-in-cart">
                <h3 class="box-title" style="border-bottom: 1px solid; padding-bottom: 15px;">{{Cart::instance('saveForLater')->count()}} item(s) Saved For Later</h3>
                    ...
                    <ul class="products-cart">
                        @foreach (Cart::instance('saveForLater')->content() as $item)
                            <li class="pr-cart-item">
                                ...
                                <div class="price-field produtc-price"><p class="price">${{$item->model->regular_price}}</p></div>
                                <div class="quantity">
                                    <p class="text-center"><a href="#" wire:click.prevent="addToCart('{{$item->rowId}}')">Add To Cart</a></p>
                                </div>
                                <div class="delete">

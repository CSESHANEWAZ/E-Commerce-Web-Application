<main id="main" class="main-site">
    ...
    <div class="container">
        ...
        <div class=" main-content-area">
            <form action="" method="" wire:submit.prevent="placeOrder" onsubmit="$('#processing').show();">
                <div class="row">
                    <div class="col-md-12">
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input  type="number" name="phone" value="" placeholder="ex: 017XXXXXXXX" wire:model="mobile">
                                    @error('mobile')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </p>
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input  type="number" name="zip-code" value="" placeholder="Your postal code" wire:model="zip_code">
                                    @error('zip_code')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </p>
                        ...
                        <div class="col-md-12">
                            <div class="wrap-address-billing">
                                ...
                                <div class="billing-address">
                                    ...
                                    <p class="row-in-form">
                                        <label for="phone">Phone number<span>*</span></label>
                                        <input  type="number" name="phone" value="" placeholder="ex: 017XXXXXXXX" wire:model="s_mobile">
                                        @error('s_mobile')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </p>
                                    ...
                                    <p class="row-in-form">
                                        <label for="add">Address Line1:</label>
                                        <input  type="text" name="add" value="" placeholder="Street at apartment number (line1)" wire:model="s_line1">
                                        @error('s_line1')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </p>
                                    <p class="row-in-form">
                                        <label for="add">Address Line2:</label>
                                        <input  type="text" name="add" value="" placeholder="Street at apartment number (line2)" wire:model="s_line2">
                                    </p>
                                    <p class="row-in-form">
                                        <label for="zip-code">Postcode / ZIP:</label>
                                        <input  type="number" name="zip-code" value="" placeholder="Your postal code" wire:model="s_zip_code">
                                        @error('s_zip_code')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </p>
                ...
                <div class="summary summary-checkout">
                    <div class="summary-item payment-method">
                        ...
                        <div class="choose-payment-methods">
                            ...
                            <label class="payment-method">
                                <input name="payment-method" id="payment-method-visa" value="bkash" type="radio" wire:model="payment_mode">
                                <span>Bkash</span>
                                <span class="payment-desc">There are many variations of passages of Lorem Ipsum available</span>
                            </label>
                            @error('payment_mode')
